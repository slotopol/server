...
local REELS = {
	...
	{4, 7, 7, 7, 5, 3, 4, 1, 9, 9, 9, 6, 6, 6, 9, 9, 4, 3, 4, 3, 8, 8, 8, 3, 5, 3, 5, 7, 7, 7, 8, 8, 3, 6, 5, 4, 9, 9, 9, 6, 6, 6, 1, 5, 4, 5, 4, 8, 8, 8, 7, 5},
	{7, 7, 7, 7, 7, 8, 9, 9, 9, 9, 9, 8, 8, 8, 8, 8, 4, 5, 4, 5, 3, 1, 3, 8, 8, 8, 8, 8, 3, 6, 6, 6, 6, 6, 4, 9, 6, 6, 6, 6, 9, 9, 9, 9, 9, 4, 1, 4, 5, 4, 5, 6, 6, 6, 6, 6, 1, 5, 3, 5, 3, 4, 3, 7, 7, 7, 7, 7, 4, 5, 2, 3, 4, 3, 7, 7, 7, 7, 5, 4, 9, 9, 9, 9, 9, 5, 4, 5, 4, 3, 4, 3, 5, 3, 5, 4, 5, 1, 5, 8, 8, 8, 8, 8, 3},
	{3, 5, 8, 8, 8, 8, 8, 2, 9, 5, 4, 3, 4, 8, 8, 8, 8, 8, 4, 3, 5, 9, 9, 9, 9, 9, 5, 4, 7, 9, 9, 9, 9, 9, 3, 5, 9, 9, 9, 9, 9, 1, 3, 7, 7, 7, 7, 7, 1, 3, 7, 7, 7, 7, 7, 4, 3, 5, 3, 7, 7, 7, 7, 7, 4, 5, 3, 6, 6, 6, 6, 6, 4, 5, 6, 6, 6, 6, 6, 5, 4, 3, 4, 1, 3, 4, 5, 8, 4, 6, 6, 6, 6, 6, 3, 6, 5, 8, 8, 8, 8, 8, 1, 4, 5},
	{5, 3, 5, 3, 5, 4, 5, 6, 6, 6, 6, 6, 1, 4, 5, 4, 1, 4, 8, 8, 8, 8, 8, 5, 3, 5, 9, 9, 9, 9, 9, 8, 8, 8, 8, 8, 4, 5, 4, 3, 5, 3, 7, 7, 7, 7, 5, 8, 8, 8, 8, 8, 2, 3, 7, 7, 7, 7, 7, 3, 4, 3, 5, 9, 9, 9, 9, 9, 5, 9, 3, 4, 8, 4, 3, 9, 9, 9, 9, 9, 6, 6, 6, 6, 6, 3, 4, 5, 4, 1, 6, 6, 6, 6, 4, 1, 4, 7, 7, 7, 7, 7, 3, 5, 4},
	{6, 5, 3, 8, 8, 5, 1, 6, 6, 6, 5, 4, 5, 3, 9, 9, 6, 6, 6, 9, 9, 9, 5, 1, 7, 7, 7, 4, 8, 8, 8, 4, 8, 8, 8, 5, 3, 4, 3, 4, 7, 5, 4, 3, 4, 3, 7, 7, 7, 9, 9, 9},
	-- luacheck: pop
}
...
local PAYTABLE_LINE = {
	...
	[ 3] = {0, 0, 40, 120, 500},   -- strawberry
	[ 4] = {0, 0, 20, 40, 200},    -- papaya
	[ 5] = {0, 0, 20, 40, 200},    -- grapes
	[ 6] = {0, 0, 10, 20, 100},    -- orange
	[ 7] = {0, 0, 10, 20, 100},    -- plum
	[ 8] = {0, 0, 5, 10, 50},      -- cherry
	[ 9] = {0, 0, 5, 10, 50},      -- pear
}
		...
		local function find_scatter_combs(reel_index, scat_sum, current_comb)
			if reel_index > sx then
				if scat_sum >= scat_min then
					fs_sum = fs_sum + current_comb * 2 * scat_sum
