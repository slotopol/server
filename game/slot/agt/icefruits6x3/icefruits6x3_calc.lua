-- AGT / Ice Fruits 6 reels
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{7, 7, 7, 7, 3, 4, 3, 4, 8, 2, 8, 8, 8, 8, 6, 4, 3, 7, 5, 4, 3, 4, 1, 5, 5, 5, 5, 6, 6, 6, 6},
	{5, 7, 7, 7, 7, 1, 3, 6, 6, 6, 6, 4, 6, 8, 8, 8, 8, 5, 5, 5, 5, 2, 4, 3, 4, 8, 3, 7, 4, 3, 4},
	{4, 3, 4, 3, 5, 4, 7, 7, 7, 7, 8, 4, 5, 5, 5, 5, 3, 1, 7, 8, 8, 8, 8, 6, 6, 6, 6, 2, 4, 3, 6},
	{7, 3, 7, 7, 7, 7, 3, 2, 8, 8, 8, 8, 5, 5, 5, 5, 4, 6, 4, 6, 6, 6, 6, 3, 8, 4, 1, 4, 5, 3, 4},
	{4, 3, 8, 8, 8, 8, 6, 6, 6, 6, 3, 5, 5, 5, 5, 4, 7, 7, 7, 7, 4, 3, 1, 8, 4, 2, 4, 6, 5, 3, 7},
	{4, 8, 8, 8, 8, 7, 3, 4, 5, 3, 5, 5, 5, 5, 6, 6, 6, 6, 4, 2, 1, 6, 8, 7, 7, 7, 7, 4, 3, 4, 3},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[1] = {0, 0, 40, 200, 400, 2000}, -- 1 wild
	[2] = {},                         -- 2 scatter
	[3] = {0, 0, 30, 80, 160, 500},   -- 3 grapes
	[4] = {0, 0, 20, 50, 100, 300},   -- 4 melon
	[5] = {0, 0, 20, 50, 100, 300},   -- 5 plum
	[6] = {0, 0, 10, 25, 60, 150},    -- 6 orange
	[7] = {0, 0, 10, 25, 60, 150},    -- 7 pear
	[8] = {0, 0, 10, 25, 60, 150},    -- 8 cherry
}

-- 3. PAYTABLE FOR SCATTER WINS (for 1 selected line bet)
local PAYTABLE_SCAT = {0, 0, 1, 20, 140, 800}

-- 4. CONFIGURATION
local sx, sy = 6, 3 -- screen width & height
