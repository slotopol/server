...
local REELS = {
	...
	{2, 12, 5, 11, 6, 12, 4, 7, 3, 9, 10, 11, 5, 8, 6, 7, 2, 9, 4, 7, 8, 1, 9, 4, 12, 5, 10, 3, 8, 6, 13, 11, 3, 10},
	{11, 12, 3, 9, 8, 4, 9, 5, 7, 2, 9, 6, 7, 2, 8, 5, 11, 6, 8, 10, 3, 12, 2, 10, 11, 1, 10, 4, 13, 6, 7, 5, 12, 3},
	{9, 4, 7, 5, 11, 4, 10, 1, 12, 2, 7, 5, 13, 4, 11, 2, 12, 7, 6, 12, 3, 10, 9, 6, 8, 3, 9, 10, 8, 6, 11, 5, 8, 3},
	{3, 10, 5, 11, 6, 7, 11, 6, 7, 2, 13, 3, 9, 2, 10, 1, 12, 11, 3, 12, 4, 9, 8, 5, 10, 2, 8, 5, 7, 12, 4, 8, 6, 9},
	{7, 9, 2, 10, 6, 12, 10, 3, 8, 4, 7, 6, 11, 5, 12, 4, 11, 5, 9, 6, 7, 8, 5, 10, 4, 9, 2, 12, 1, 8, 3, 13, 11, 3},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 200, 2000, 10000}, -- cleopatra
	[ 2] = {0, 2, 25, 100, 750},      -- scarab
	[ 3] = {0, 2, 25, 100, 750},      -- broom
	[ 4] = {0, 0, 15, 100, 400},      -- shield
	[ 5] = {0, 0, 10, 75, 250},       -- stick
	[ 6] = {0, 0, 10, 50, 250},       -- eye
	[ 7] = {0, 0, 10, 50, 125},       -- ace
	[ 8] = {0, 0, 5, 50, 100},        -- king
