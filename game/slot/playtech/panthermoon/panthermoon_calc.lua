...
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 250, 2500, 10000}, -- panther
	[ 2] = {0, 2, 25, 125, 750},      -- owl
	[ 3] = {0, 2, 25, 125, 750},      -- wolf
	[ 4] = {0, 0, 20, 100, 500},      -- butterfly
	[ 5] = {0, 0, 15, 75, 250},       -- red
	[ 6] = {0, 0, 15, 75, 250},       -- blue
	[ 7] = {0, 0, 10, 40, 150},       -- ace
	[ 8] = {0, 0, 10, 40, 150},       -- king
	[ 9] = {0, 0, 5, 30, 125},        -- queen
