-- CT Interactive / Pyramid of Gold
-- RTP calculation
...
local PAYTABLE_LINE = {
	...
	[ 2] = {0, 0, 25, 100, 400},  -- woman
	[ 3] = {0, 0, 25, 100, 400},  -- man
	[ 4] = {0, 0, 20, 75, 250},   -- eagle
	[ 5] = {0, 0, 20, 75, 250},   -- leopard
	[ 6] = {0, 0, 5, 50, 150},    -- mask1
	[ 7] = {0, 0, 5, 50, 150},    -- mask2
	[ 8] = {0, 0, 5, 20, 100},    -- ace
	[ 9] = {0, 0, 5, 20, 100},    -- king
	[10] = {0, 0, 5, 20, 100},    -- queen
	[11] = {0, 0, 5, 20, 100},    -- jack
