-- CT Interactive / Lucky Dollar
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{6, 7, 12, 11, 1, 9, 8, 11, 13, 4, 12, 3, 7, 13, 8, 3, 10, 4, 7, 12, 6, 10, 2, 9, 5, 8, 6, 9, 5, 13, 4, 11, 5, 10, 12, 3, 13},
	{12, 13, 3, 8, 10, 6, 13, 4, 9, 5, 11, 1, 10, 4, 11, 6, 7, 11, 5, 7, 3, 13, 2, 7, 8, 12, 5, 8, 9, 10, 4, 12, 3, 9, 12, 13, 6},
	{9, 12, 6, 10, 3, 13, 9, 5, 7, 6, 10, 3, 8, 4, 13, 5, 9, 3, 11, 8, 6, 7, 11, 10, 8, 4, 7, 13, 1, 12, 11, 2, 12, 5, 13, 12, 4},
	{7, 3, 12, 8, 3, 13, 6, 11, 4, 10, 7, 4, 9, 5, 13, 3, 10, 13, 6, 7, 12, 13, 9, 2, 8, 4, 11, 8, 1, 12, 5, 11, 6, 12, 10, 9, 5},
	{3, 7, 5, 12, 4, 13, 12, 5, 10, 6, 13, 8, 3, 13, 6, 12, 10, 9, 7, 4, 9, 11, 4, 10, 6, 8, 1, 11, 3, 8, 5, 7, 13, 11, 2, 9},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[ 1] = {0, 20, 250, 2000, 9000}, -- wild
	[ 2] = {},                       -- scatter
	[ 3] = {0, 5, 20, 200, 700},     -- cowboy
	[ 4] = {0, 5, 20, 200, 700},     -- miner
	[ 5] = {0, 0, 15, 50, 600},      -- whore
	[ 6] = {0, 0, 15, 50, 600},      -- guns
	[ 7] = {0, 0, 15, 50, 600},      -- shovels
	[ 8] = {0, 0, 10, 25, 200},      -- ace
	[ 9] = {0, 0, 10, 25, 200},      -- king
...
local function calculate(reels)
	...
	do
		local rtp_line = calculate_line_ev(true) / N
	...
	local rtp_total
	do
		local rtp_line = calculate_line_ev(false) / N
