-- CT Interactive / Goddess of Bells
-- RTP calculation
...
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 250, 2500, 9000}, -- lady
	[ 2] = {0, 2, 25, 125, 750},     -- clever
	[ 3] = {0, 2, 25, 125, 750},     -- coin
	[ 4] = {0, 0, 20, 100, 400},     -- grape
	[ 5] = {0, 0, 15, 75, 250},      -- shore
	[ 6] = {0, 0, 15, 75, 250},      -- ladybug
	[ 7] = {0, 0, 10, 50, 125},      -- orange
	[ 8] = {0, 0, 10, 50, 125},      -- cherry
	[ 9] = {0, 0, 5, 25, 100},       -- ace
	[10] = {0, 0, 5, 25, 100},       -- king
	[11] = {0, 0, 5, 25, 100},       -- queen
	[12] = {0, 2, 5, 25, 100},       -- jack
	[13] = {},                       -- bell
}
