-- CT Interactive / Fortune Pyramid
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{7, 7, 7, 7, 7, 1, 1, 1, 6, 6, 6, 6, 3, 3, 3, 5, 5, 5, 5, 2, 6, 6, 6, 6, 6, 4, 4, 4, 4, 8, 8, 8, 8, 8, 4, 4, 4, 4, 8, 8, 8, 8, 8, 3, 3, 3, 7, 7, 7, 7, 7, 5, 5, 5, 5, 2},
	{6, 6, 6, 6, 6, 5, 5, 5, 5, 8, 8, 8, 8, 8, 2, 1, 1, 1, 3, 3, 3, 7, 7, 7, 7, 7, 6, 6, 6, 6, 2, 5, 5, 5, 5, 4, 4, 4, 4, 7, 7, 7, 7, 7, 3, 3, 3, 4, 4, 4, 4, 8, 8, 8, 8, 8},
	{4, 4, 4, 4, 5, 5, 5, 5, 4, 4, 4, 4, 7, 7, 7, 7, 7, 1, 1, 1, 6, 6, 6, 6, 6, 2, 5, 5, 5, 5, 8, 8, 8, 8, 8, 3, 3, 3, 8, 8, 8, 8, 8, 6, 6, 6, 6, 3, 3, 3, 7, 7, 7, 7, 7, 2},
	{7, 7, 7, 7, 7, 1, 1, 1, 8, 8, 8, 8, 8, 6, 6, 6, 6, 6, 4, 4, 4, 4, 6, 6, 6, 6, 6, 3, 3, 3, 8, 8, 8, 8, 8, 4, 4, 4, 4, 5, 5, 5, 5, 7, 7, 7, 7, 7, 3, 3, 3, 2, 5, 5, 5, 5, 2},
	{5, 5, 5, 5, 6, 6, 6, 6, 2, 6, 6, 6, 6, 6, 1, 1, 1, 3, 3, 3, 5, 5, 5, 5, 3, 3, 3, 7, 7, 7, 7, 7, 8, 8, 8, 8, 8, 4, 4, 4, 4, 2, 4, 4, 4, 4, 8, 8, 8, 8, 8, 7, 7, 7, 7, 7},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[1] = {0, 0, 40, 750, 1000}, -- wild
	[2] = {0, 0, 0, 0, 0},       -- scatter
	[3] = {0, 0, 10, 50, 500},   -- scarab
	[4] = {0, 0, 10, 40, 200},   -- cross
	[5] = {0, 0, 10, 40, 200},   -- eye
	[6] = {0, 0, 5, 20, 100},    -- ring
	[7] = {0, 0, 5, 20, 100},    -- cup
	[8] = {0, 0, 5, 20, 100},    -- bowl
