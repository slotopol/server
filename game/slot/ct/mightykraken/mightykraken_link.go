...
var Info = game.AlgInfo{
	Aliases: []game.GameAlias{
		...
		{Prov: "CT Interactive", Name: "Lucky Clover", LNum: 5, Date: game.Date(2016, 7, 1)},       // see: https://www.slotsmate.com/software/ct-interactive/casino-technology-lucky-clover
...
func init() {
	...
	game.DataRouter["ctinteractive/mightykraken/rmap"] = &ReelsMap
