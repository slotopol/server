-- CT Interactive / Hit the Hot RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{10, 10, 10, 9, 9, 9, 5, 5, 5, 7, 7, 7, 9, 9, 9, 10, 10, 10, 2, 5, 5, 6, 6, 6, 7, 7, 7, 3, 3, 3, 3, 8, 8, 8, 6, 6, 6, 2, 4, 4, 4, 4, 4, 8, 8, 8},
	{9, 9, 9, 2, 8, 8, 8, 7, 7, 7, 10, 10, 10, 9, 9, 9, 5, 5, 5, 6, 6, 6, 3, 3, 3, 3, 4, 4, 4, 4, 2, 6, 6, 6, 1, 1, 1, 1, 10, 10, 10, 5, 5, 5, 7, 7, 7, 8, 8, 8},
	{6, 6, 6, 4, 4, 4, 4, 5, 5, 5, 9, 9, 9, 3, 3, 3, 3, 6, 6, 6, 7, 7, 7, 10, 10, 10, 7, 7, 7, 8, 8, 8, 2, 8, 8, 8, 2, 10, 10, 10, 1, 1, 1, 1, 5, 5, 5, 9, 9, 9},
	{1, 1, 1, 1, 8, 8, 8, 7, 7, 7, 5, 5, 5, 4, 4, 4, 4, 4, 2, 6, 6, 6, 10, 10, 10, 9, 9, 9, 10, 10, 10, 7, 7, 7, 8, 8, 8, 6, 6, 6, 2, 3, 3, 3, 3, 5, 5, 9, 9, 9},
	{6, 6, 6, 9, 9, 9, 2, 4, 4, 4, 4, 4, 9, 9, 9, 10, 10, 10, 6, 6, 6, 5, 5, 5, 7, 7, 7, 3, 3, 3, 3, 10, 10, 10, 8, 8, 8, 5, 5, 8, 8, 8, 7, 7, 7, 2},
	-- luacheck: pop
}
...
local PAYTABLE_LINE = {
	...
	[ 2] = {0, 0, 0, 0, 0},       -- scatter
	[ 3] = {0, 4, 40, 100, 1500}, -- clover
	[ 4] = {0, 0, 30, 100, 1250}, -- horseshoe
	[ 5] = {0, 0, 10, 60, 500},   -- bell
	[ 6] = {0, 0, 10, 40, 100},   -- apple
	[ 7] = {0, 0, 7, 35, 100},    -- orange
	[ 8] = {0, 0, 7, 35, 100},    -- lemon
	[ 9] = {0, 0, 7, 35, 100},    -- plum
	[10] = {0, 0, 7, 35, 100},    -- cherry
}

-- 3. PAYTABLE FOR SCATTER WINS (for 1 selected line bet)
local PAYTABLE_SCAT = {0, 0, 2, 25, 100}
