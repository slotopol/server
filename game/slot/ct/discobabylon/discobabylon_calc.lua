-- CT Interactive / Disco Babylon
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{4, 6, 9, 10, 6, 7, 5, 6, 10, 5, 8, 4, 7, 3, 10, 9, 8, 10, 5, 7, 3, 9, 6, 4, 2, 7, 5, 8, 7, 9, 4, 8, 9, 10, 8},
	{6, 4, 5, 10, 4, 10, 1, 5, 9, 7, 2, 5, 7, 8, 1, 4, 6, 9, 10, 3, 9, 8, 10, 8, 3, 8, 6, 7, 8, 9, 3, 7, 10, 6, 5, 9, 7},
	{10, 6, 4, 8, 10, 7, 3, 10, 8, 9, 3, 9, 8, 6, 8, 5, 9, 7, 3, 8, 6, 4, 5, 10, 2, 7, 5, 9, 1, 10, 7, 5, 1, 4, 6, 9, 7},
	{7, 10, 9, 4, 8, 7, 6, 2, 10, 5, 8, 4, 9, 3, 8, 7, 8, 10, 3, 9, 5, 6, 9, 7, 3, 10, 9, 8, 4, 1, 7, 5, 6, 1, 5, 6, 10},
	{8, 9, 7, 8, 7, 6, 4, 8, 9, 5, 4, 9, 7, 4, 9, 8, 7, 10, 3, 9, 5, 10, 6, 10, 7, 3, 8, 10, 6, 5, 4, 10, 2, 6, 5},
	-- luacheck: pop
}
...
local PAYTABLE_LINE = {
	...
	[ 2] = {},                     --  2 scatter
	[ 3] = {0, 0, 50, 500, 10000}, --  3 dj
	[ 4] = {0, 0, 20, 250, 1000},  --  4 cocktail
	[ 5] = {0, 0, 10, 50, 500},    --  5 cup
	[ 6] = {0, 0, 10, 50, 500},    --  6 bull
	[ 7] = {0, 0, 5, 20, 250},     --  7 ace
	[ 8] = {0, 0, 5, 10, 250},     --  8 king
	[ 9] = {0, 0, 5, 10, 100},     --  9 queen
	[10] = {0, 0, 5, 10, 100},     -- 10 jack
}

-- 3. PAYTABLE FOR SCATTER WINS (for 1 selected line bet)
local PAYTABLE_SCAT = {0, 0, 5, 10, 100}
