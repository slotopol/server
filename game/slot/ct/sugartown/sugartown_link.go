...
var Info = game.AlgInfo{
	Aliases: []game.GameAlias{
		...
		{Prov: "CT Interactive", Name: "Guardian of Asgard", Date: game.Date(2024, 6, 14)},      // see: https://www.slotsmate.com/software/ct-interactive/guardian-of-asgard
...
func init() {
	...
	game.DataRouter["ctinteractive/sugartown/rmap"] = &ReelsMap
