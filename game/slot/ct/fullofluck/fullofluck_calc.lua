-- CT Interactive / Full of Luck
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{9, 10, 4, 7, 11, 5, 13, 6, 9, 4, 8, 9, 4, 7, 6, 12, 3, 13, 2, 12, 8, 3, 7, 5, 13, 11, 10, 3, 8, 6, 7, 1, 10, 3, 12, 4, 11, 5},
	{11, 5, 12, 3, 10, 7, 3, 13, 4, 7, 3, 9, 2, 7, 4, 10, 1, 8, 7, 5, 13, 10, 6, 12, 4, 11, 9, 4, 8, 6, 13, 3, 11, 9, 5, 8, 6, 12},
	{11, 3, 10, 9, 4, 12, 3, 9, 7, 5, 8, 2, 10, 5, 13, 12, 4, 9, 11, 3, 12, 6, 13, 5, 10, 4, 8, 6, 7, 4, 13, 3, 11, 6, 8, 1, 7},
	{8, 3, 13, 6, 7, 8, 6, 10, 4, 8, 5, 7, 2, 13, 5, 10, 6, 7, 9, 3, 12, 4, 13, 12, 4, 11, 10, 4, 11, 3, 9, 11, 3, 7, 1, 9, 12, 5},
	{11, 9, 3, 7, 4, 10, 1, 12, 13, 4, 9, 8, 6, 9, 7, 2, 10, 6, 11, 3, 8, 5, 13, 3, 12, 5, 13, 3, 11, 6, 8, 4, 12, 5, 10, 7, 4},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 250, 2000, 9000}, -- wild
	[ 2] = {},                       -- scatter
	[ 3] = {0, 2, 20, 150, 700},     -- dollar
	[ 4] = {0, 2, 20, 150, 700},     -- horseshoe
	[ 5] = {0, 0, 15, 50, 200},      -- bug
	[ 6] = {0, 0, 15, 50, 200},      -- bell
	[ 7] = {0, 0, 15, 50, 200},      -- jug
	[ 8] = {0, 0, 5, 25, 150},       -- ace
	[ 9] = {0, 0, 5, 25, 150},       -- king
