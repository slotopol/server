-- CT Interactive / Island Vacation
-- RTP calculation
...
local REELS_REG = {
	-- luacheck: push ignore 631
	{6, 8, 4, 11, 12, 3, 9, 5, 11, 9, 13, 5, 10, 7, 12, 4, 13, 3, 10, 1, 9, 12, 7, 10, 3, 11, 8, 6, 10, 4, 13, 12, 2, 13, 6, 8, 7, 11, 5, 9},
	{6, 9, 4, 12, 7, 8, 3, 11, 6, 12, 4, 11, 8, 10, 7, 8, 3, 12, 13, 5, 12, 10, 3, 11, 10, 5, 9, 7, 13, 6, 9, 1, 13, 5, 11, 10, 4, 9, 2, 13},
	{8, 9, 4, 13, 5, 12, 11, 3, 12, 7, 10, 4, 9, 12, 4, 8, 7, 11, 6, 10, 5, 13, 10, 3, 8, 2, 12, 3, 10, 6, 8, 11, 6, 9, 5, 13, 11, 7, 9, 13, 1},
	{13, 4, 10, 7, 12, 10, 5, 9, 7, 8, 6, 10, 4, 12, 3, 11, 8, 2, 13, 4, 11, 5, 9, 1, 13, 7, 12, 11, 3, 13, 9, 5, 8, 6, 11, 12, 3, 10, 6},
	{3, 12, 6, 13, 7, 11, 6, 10, 9, 3, 12, 2, 10, 8, 4, 10, 5, 9, 8, 6, 13, 5, 11, 12, 7, 10, 3, 13, 4, 12, 11, 7, 13, 5, 11, 4, 9, 1, 8},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 250, 2500, 15000}, -- wild
	[ 2] = {},                        -- scatter
	[ 3] = {0, 2, 25, 125, 750},      -- mask
	[ 4] = {0, 2, 25, 125, 750},      -- fins
	[ 5] = {0, 0, 20, 100, 400},      -- compass
	[ 6] = {0, 0, 15, 75, 250},       -- clownfish
	[ 7] = {0, 0, 15, 75, 250},       -- butterfly
	[ 8] = {0, 0, 10, 50, 125},       -- ace
