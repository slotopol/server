...
var Info = game.AlgInfo{
	Aliases: []game.GameAlias{
		...
		{Prov: "CT Interactive", Name: "Christmas Storm", LNum: 30, Date: game.Date(2023, 11, 30)},  // see: https://www.livebet2.com/casino/slots/ct-interactive/christmas-storm
		{Prov: "CT Interactive", Name: "30 Fruitata Wins", LNum: 30, Date: game.Date(2023, 11, 22)}, // see: https://www.livebet2.com/casino/slots/ct-interactive/30-fruitata-wins
	},
...
func init() {
	...
	game.DataRouter["ctinteractive/winstorm/rmap"] = &ReelsMap
