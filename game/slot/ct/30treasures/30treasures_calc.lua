-- CT Interactive / 30 Treasures
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{8, 8, 8, 8, 8, 8, 5, 5, 5, 5, 3, 7, 7, 7, 7, 7, 9, 9, 9, 9, 9, 9, 5, 4, 2, 4, 3, 6, 6, 6, 6, 6, 10, 10, 10, 10, 10, 10, 1, 1, 1, 3, 4},
	{1, 1, 1, 4, 3, 9, 9, 9, 9, 9, 9, 3, 4, 3, 5, 5, 5, 5, 2, 5, 6, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8, 7, 7, 7, 7, 7, 4, 10, 10, 10, 10, 10, 10},
	{5, 6, 6, 6, 6, 6, 4, 10, 10, 10, 10, 10, 10, 4, 7, 7, 7, 7, 7, 4, 5, 5, 5, 5, 3, 9, 9, 9, 9, 9, 9, 3, 1, 1, 1, 3, 8, 8, 8, 8, 8, 2},
	{6, 6, 6, 6, 6, 3, 2, 4, 3, 5, 9, 9, 9, 9, 9, 9, 4, 7, 7, 7, 7, 7, 10, 10, 10, 10, 10, 10, 8, 8, 8, 8, 8, 8, 1, 1, 1, 4, 5, 5, 5, 5, 3},
	{10, 10, 10, 10, 10, 10, 5, 5, 5, 5, 2, 1, 1, 1, 4, 9, 9, 9, 9, 9, 9, 4, 3, 4, 5, 3, 7, 7, 7, 7, 7, 6, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8, 3},
	-- luacheck: pop
}

-- 2. PAYTABLE FOR LINE WINS (indexed by symbol ID)
local PAYTABLE_LINE = {
	[ 1] = {0, 0, 150, 300, 1000}, -- wild
	[ 2] = {},                     -- scatter
	[ 3] = {0, 0, 20, 100, 400},   -- crown
	[ 4] = {0, 0, 20, 100, 400},   -- cup
	[ 5] = {0, 0, 15, 50, 200},    -- melon
	[ 6] = {0, 0, 15, 50, 200},    -- apple
	[ 7] = {0, 0, 5, 15, 100},     -- orange
	[ 8] = {0, 0, 5, 15, 100},     -- lemon
	[ 9] = {0, 0, 5, 15, 100},     -- plum
	[10] = {0, 0, 5, 15, 100},     -- cherry
}

-- 3. PAYTABLE FOR SCATTER WINS (for 1 selected line bet)
local PAYTABLE_SCAT = {0, 0, 10, 30, 500}
