...
var Info = game.AlgInfo{
	Aliases: []game.GameAlias{
		...
		{Prov: "CT Interactive", Name: "40 Roosters", LNum: 40, Date: game.Date(2019, 2, 11)},      // see: https://www.slotsmate.com/software/ct-interactive/40-roosters
...
func init() {
	...
	game.DataRouter["ctinteractive/40megaslot/rmap"] = &ReelsMap
