...
local PAYTABLE_LINE = {
	...
	[ 2] = {0, 0, 0, 0, 0},       -- scatter
	[ 3] = {0, 0, 25, 100, 400},  -- car
	[ 4] = {0, 0, 25, 100, 400},  -- tv
	[ 5] = {0, 0, 20, 75, 250},   -- recorder
	[ 6] = {0, 0, 20, 75, 250},   -- projector
	[ 7] = {0, 0, 5, 50, 150},    -- boots
	[ 8] = {0, 0, 5, 50, 150},    -- column
	[ 9] = {0, 0, 5, 20, 100},    -- ace
	[10] = {0, 0, 5, 20, 100},    -- king
	[11] = {0, 0, 5, 20, 100},    -- queen
	[12] = {0, 0, 5, 20, 100},    -- jack
}

-- 3. PAYTABLE FOR SCATTER WINS (for 1 selected line bet)
local pay, fs = 2, 5 -- scatter pays and number of free spins awarded
