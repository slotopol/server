...
local PAYTABLE_LINE = {
	[ 1] = {0, 10, 250, 2500, 9000}, -- banana
	[ 2] = {0, 2, 30, 120, 800},     -- strawberry
	[ 3] = {0, 2, 30, 120, 800},     -- water
	[ 4] = {0, 0, 20, 100, 400},     -- pineapple
	[ 5] = {0, 0, 20, 70, 250},      -- mango
	[ 6] = {0, 0, 20, 70, 250},      -- coconu
	[ 7] = {0, 0, 10, 50, 120},      -- ace
...
-- 4. FREE SPINS TABLE
local FREESPIN_SCAT = {0, 0, 45, 45, 45}
...
local function calculate(reels_reg, reels_bon)
	...
	do
		...
		print(string.format("RTP = sq*rtp(sym) = %.5g*%.5g = %.6f%%", sq, rtp_sym*100, rtp_fs*100))
	end
	local rtp_total
	do
		reels = reels_reg
