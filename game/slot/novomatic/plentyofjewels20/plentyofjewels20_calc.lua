-- Novomatic / Plenty of Jewels 20 hot
-- RTP calculation

-- 1. REEL STRIPS DATA
local REELS = {
	-- luacheck: push ignore 631
	{1, 4, 6, 8, 4, 5, 6, 4, 3, 8, 6, 4, 8, 6, 4, 8, 6, 3, 8, 7, 4, 6, 8, 4, 6, 8, 4, 7, 2, 8, 4, 6, 5, 8, 4, 6},
	{5, 3, 1, 5, 3, 7, 5, 3, 7, 5, 3, 7, 5, 8, 3, 7, 4, 5, 7, 3, 5, 7, 3, 2, 8, 4, 7, 3, 6, 5, 7, 3, 5, 6, 7},
	{6, 1, 4, 8, 6, 4, 8, 6, 4, 8, 6, 3, 8, 7, 5, 6, 4, 8, 6, 3, 8, 4, 6, 8, 7, 4, 8, 6, 4, 8, 6, 4, 5, 2, 4},
	{5, 3, 1, 5, 3, 7, 5, 3, 7, 5, 3, 7, 5, 8, 3, 7, 4, 5, 7, 3, 5, 7, 3, 2, 8, 4, 7, 3, 6, 5, 7, 3, 5, 6, 7},
	{1, 4, 6, 8, 4, 5, 6, 4, 3, 8, 6, 4, 8, 6, 4, 8, 6, 3, 8, 7, 4, 6, 8, 4, 6, 8, 4, 7, 2, 8, 4, 6, 5, 8, 4, 6},
	-- luacheck: pop
}
...
local PAYTABLE_LINE = {
	[1] = {0, 0, 100, 1000, 5000}, -- wild
	[2] = {},                      -- scatter
	[3] = {0, 0, 50, 200, 500},    -- topaz
	[4] = {0, 0, 20, 50, 200},     -- sapphire
	[5] = {0, 0, 20, 50, 200},     -- heliodor
	[6] = {0, 0, 20, 50, 200},     -- ruby
	[7] = {0, 0, 20, 50, 200},     -- tanzanite
	[8] = {0, 0, 20, 50, 200},     -- emerald
}
