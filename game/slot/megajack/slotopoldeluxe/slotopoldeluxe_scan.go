...
func CalcStat(ctx context.Context, mrtp float64) float64 {
	...
	var calc = func(w io.Writer) float64 {
		...
		var qmje1 = s.BonCountF(mje1) / reshuf / float64(g.Sel)
		var rtpmje1 = slotopol.Emje * 1 * qmje1 * 100
		var qmje3 = s.BonCountF(mje3) / reshuf / float64(g.Sel)
		var rtpmje3 = slotopol.Emje * 3 * qmje3 * 100
		var qmje6 = s.BonCountF(mje6) / reshuf / float64(g.Sel)
		var rtpmje6 = slotopol.Emje * 6 * qmje6 * 100
		var qmjm = s.BonCountF(mjm) / reshuf / float64(g.Sel)
