...
func CalcStat(ctx context.Context, mrtp float64) float64 {
	...
	var calc = func(w io.Writer) float64 {
		...
		var qmje1 = s.BonusHitsF(mje1) / reshuf / float64(g.Sel)
		var rtpmje1 = slotopol.Emje * 1 * qmje1 * 100
		var qmje3 = s.BonusHitsF(mje3) / reshuf / float64(g.Sel)
		var rtpmje3 = slotopol.Emje * 3 * qmje3 * 100
		var qmje6 = s.BonusHitsF(mje6) / reshuf / float64(g.Sel)
