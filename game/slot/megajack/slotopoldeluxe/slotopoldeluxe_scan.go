...
func CalcStat(ctx context.Context, sp *slot.ScanPar) float64 {
	...
	var calc = func(w io.Writer) float64 {
		...
		var qmje1 = s.BonusHits(mje1) / N / float64(g.Sel)
		var rtpmje1 = slotopol.Emje * 1 * qmje1
		var qmje3 = s.BonusHits(mje3) / N / float64(g.Sel)
		var rtpmje3 = slotopol.Emje * 3 * qmje3
		var qmje6 = s.BonusHits(mje6) / N / float64(g.Sel)
